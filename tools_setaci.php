...
include("dbcon.php");
if($_GET['act']=='save'){
	$eed=mysql_query("SELECT * FROM `employee` where deptId=116 order by lastName,firstName");
...
$ee=mysql_query("SELECT * FROM `employee` where deptId=116 and isACtive=1 order by lastName,firstName");
...
<div id="main_content_wrap" class="container_12">
	  <form action="tools_setaci.php?act=save" method="post" name="sadsa">
  		<table>
			<tr>
				<td>Employee</td>
				<td>Maker</td>
