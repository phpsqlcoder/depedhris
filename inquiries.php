...
$insertq=mysql_query("INSERT INTO inquiries_reply(`msg`, `sender`,  `sent`, `inquiry_id`)VALUES('".$_POST['reply']."','".$_SESSION['fullName']."','".date('Y-m-d H:i:s')."','".$_POST['inquiry_id']."')");
            ...
            <div class="content-page">
               <?php if(isset($_GET['success'])){
                  echo '<div class="alert alert-info">
                        <strong>Success!</strong> Message was successfully sent.
                     </div>';
               } ?>
              <div class="row">
                            ...
                            <div class="panel panel-success">
                               <div class="panel-heading">
                                  <h4 class="panel-title">
									 ...
									 <?php echo $s."<span style='float:right;'>".date('F d,Y h:i A',strtotime($r->sent))."</span>";?>
                                     </a>
                                  </h4>
                               </div>
                                    ...
                                    <?php if($r->sender_id > 0){ ?>
                                       <div>
                                          ...
                                          <form action="inquiries.php?sendreply=ok" method="post">
                                             ...
                                             <input type="hidden" name="recipient" value="<?php echo $r->ndex;?>">
                                          <h4>Add Reply</h4>
