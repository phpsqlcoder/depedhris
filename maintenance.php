...
<div id="rcont">
 ...
 <div id="icondock" class="grid_12">	
   <ul>
	...
	<li><a href="category.php"><img src="images/category.png" width="26" height="26" /><br>Employee Category</a></li>
	<li><a href="category_sub.php"><img src="images/category.png" width="26" height="26" /><br>Employee Sub-category</a></li>
       </ul>  
  <p>&nbsp;</p>
   </div> 
  <h2>&nbsp;</h2>		
