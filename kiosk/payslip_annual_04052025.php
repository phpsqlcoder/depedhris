		...
		<td align="center">
				...
				<table style="font-family:Arial Rounded MT Bold;font-size:20px;color:maroon;">
					<tr><td><select name="cutoff" onchange="document.frmpayslip.submit();" class="form-control">
						...
						<?php 
						echo '<option value="Leave">Sick Leave Conversion (2023)</option>';
						if($yvl == 1 ){ echo '<option value="VLeave">Vacation Leave Conversion (2023)</option>'; }?>
					</select></td></tr>
				</table>
				</form>
			<?php if($_GET['act']=='go'){?>	
