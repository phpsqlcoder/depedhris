      ...
      <div class="container">
        ...
        <div class="header-navigation font-transform-inherit" style="width:100%;position:relative;top:15px;">
          <ul id="menu-bar" class=" col-md-12 col-sm-12">
            ...
            <li>
              <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="#" title="INQUIRIES is a venue where you can ask questions, give feedback and recommend quality improvements. FAQs is a list of questions and answers relating to a particular subject.">
...
<li><a data-toggle="modal" target="_blank" href="../HRFORMS/Multi-Purpose.pdf" href="#basicd">Pagibig Multi-Purpose Loan</a></li>
...
<li><a data-toggle="modal" target="_blank" href="../HRFORMS/SSS_Change Request.pdf" href="#basicd">SSS Change Request</a></li>
...
<li><a data-toggle="modal" target="_blank" href="../HRFORMS/BIRForm2305_Update of ER and EE Info.pdf" href="#basicd">BIR Form 2305</a></li>
            ...
            <li><a href="main_forum.php" title="iEXPRESS is a venue where you can share your thoughts and to stay in contact with your colleagues.  Users can post message, share articles, quotes and respond or link to the information posted by others."><strong>iExpress</strong></a></li>
