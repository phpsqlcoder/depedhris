			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding">
					<ul class="nav nav-pills nav-stacked">
						<li>
							<a href="mailbox.php"><i class="fa fa-inbox"></i> Inbox <span class="pull-right"><?php echo $inbox; ?></a>
						</li>
						<li class="active"><a href="mailboxsent.php"><i class="fa fa-envelope-o"></i> Sent</a></li>
					...
					<div class="table-responsive mailbox-messages">
						<table class="table table-hover table-striped">
							...
							<tbody>
								...
								$sql="select m.*, u.fullName, n.name as notif from message_board m left join notifications as n on n.ndex = m.notification_id left join users as u on u.ndex=m.to where m.from = ".$_SESSION['ndex']			."	 order by ndex desc";

								$result = mysql_query($sql);
								while($rows = mysql_fetch_array($result)){
									if($rows['attachment'] != ""){
										$attachment = '<i class="fa fa-paperclip"> <a target="_blank" href="attachments/mailattachments/'.$rows['attachment'].'">'.$rows['attachment'].'</a></i>';
									} else {
										$attachment = "";
									}
									?>
...
<div class="modal fade" id="modal-restore">
  	<div class="modal-dialog">
	    <div class="modal-content">
		    ...
		    <form action="trashmailbox.php?act=restore" method="post">
