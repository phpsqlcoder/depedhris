...
if($_GET['act']=='save'){
	...
	$lastempno=mysql_fetch_object(mysql_query("SELECT employeeNo FROM employee WHERE employmentStatus='".$_POST['employmentStatus']."' ORDER BY employeeNo DESC"));
	if($_POST['employeeNo']<1){
	...
	for($aa=1;$aa<=$_POST['numdep'];$aa++){
		...
		$insertdependents=mysql_query("
			UPDATE empdependents SET `name`='".$_POST[$aa.'name']."', `birthDate`='".$_POST[$aa.'birthDate']."', `relationship`='".$_POST[$aa.'relationship']."', `occupation`='".$_POST[$aa.'occupation']."', `company`='".$_POST[$aa.'company']."', `isDependent`='".$dependent."'
	...
	for($aa=1;$aa<=$_POST['personalcounter'];$aa++){
		...
		$insertdependents=mysql_query("
			INSERT INTO empdependents (`employeeId`,`name`, `birthDate`, `relationship`, `status`, `occupation`, `company`, `isDependent`)
			VALUES ('".$id."','".$_POST['nameper'.$aa]."','".$_POST['birthDate'.$aa]."','".$_POST['relationship'.$aa]."','1','".$_POST['occupation'.$aa]."','".$_POST['company'.$aa]."','".$dependent."')
		");
	}
	//education
	...
	for($dd=1;$dd<=$_POST['numtra'];$dd++){
		$inserttraining=mysql_query("
			UPDATE emptrainings SET `name`='".$_POST[$dd.'nametraining']."', `fromDate`='".$_POST[$dd.'fromDateprof']."', `endDate`='".$_POST[$dd.'endDateprof']."'
		...
		$dependents.="
			<tr>
						...
						<table>					
							<tr>
								<td>
									<input type='Checkbox' name='isDependent' ".$check.">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
								...
								<td><input type='Text' name='".$deppart."birthDate' id='".$deppart."birthDate' size='15' value='".$a->birthDate."' style='color:gray;' onfocus='if(this.value=='Birth Date'){this.value='';}this.style.color='black';'><a href='javascript:show_calendar('employeefrm2.".$deppart."birthDate');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a></td>
	...
	$education.="<tr>
						...
						<table>					
							<tr><input type='hidden' name='".$edupart."eduid' size='25' value='".$b->ndex."'>
								...
								<td><input type='Text' name='".$edupart."fromDateedu' value='".$b->fromDate."' id='".$edupart."fromDateedu' size='15'><a href='javascript:show_calendar('employeefrm2.".$edupart."fromDateedu');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a></td>
								<td><input type='Text' name='".$edupart."toDateedu' id='".$edupart."toDateedu' size='15' value='".$b->toDate."'><a href='javascript:show_calendar('employeefrm2.".$edupart."toDateedu');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a></td>								
							</tr>
						</table>
						</div>
						</td>
			...
			<tr>
						...
						<table>
							...
							<tr>							
								...
								<td><input type='Text' name='".$emppart."fromDateemp' id='".$emppart."fromDateemp' size='6' value='".$c->fromDate."'><a href='javascript:show_calendar('employeefrm2.".$emppart."fromDateemp');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a>
									 to 
									 <input type='Text' name='".$emppart."endDateemp' id='".$emppart."endDateemp' size='6' value='".$c->endDate."'><a href='javascript:show_calendar('employeefrm2.".$emppart."endDateemp');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a></td>
							</tr>
							<tr>
		...
		<tr>
			...
			<table>
				<tr><input type='hidden' name='".$trapart."traid' size='25' value='".$d->ndex."'>
					...
					<td><td>Date/s :&nbsp;&nbsp;<input type='Text' name='".$trapart."fromDateprof' id='".$trapart."fromDateprof' value='".$d->fromDate."' size='6'><a href='javascript:show_calendar('employeefrm2.".$trapart."fromDateprof');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a>
					 to 
					 <input type='Text' name='".$trapart."endDateprof' id='".$trapart."endDateprof' size='6' value='".$d->endDate."'>
					 <a href='javascript:show_calendar('employeefrm2.".$trapart."endDateprof');' onMouseOver='window.status='Date Picker'; overlib(''); return true;' onMouseOut='window.status=''; nd(); return true;'><img src='b_calendar.png' width=19 border=0></a>
					 </td></td>
				</tr>
...
<title>HRIS - Davao Doctors Hospital</title>
	...
	<script type="text/javascript" src="scriptaculous.js"></script>
		<script type="text/javascript">
			...
			//	alert(document.getElementById('dateHired').value);
...
<div id="main_content_wrap" class="container_12">
     <h2>Update 201 File&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img height="50" width="60" src="picture/<?php echo $img;?>"></h2>
<form method="post" name="employeefrm2" action="<?php echo $_SERVER['PHP_SELF']; ?>?act=save&id=<?php echo $id;?>" enctype="multipart/form-data" onsubmit="return checks();">
	 <table style="font-size:11px;">
	 	<tr>
			<td>
				<table>
				 	<tr>
						<td>Full Name:&nbsp;&nbsp;</td>
						<td><input type="Text" name="firstName" readonly="readonly" size="15" value="<?php echo $em->firstName;?>">
						<input type="Text" name="middleName" readonly="readonly" size="15" value="<?php echo $em->middleName;?>">
						<input type="Text" name="lastName" readonly="readonly" size="15" value="<?php echo $em->lastName;?>"></td>
					</tr>
					<tr><td>Position:&nbsp;&nbsp;</td><td><select name="position"><option selected="selected" value="<?php echo $em->position;?>"><?php echo $em->newposition;?></select></td></tr>					
					<tr><td>Division:&nbsp;&nbsp;</td><td><select name="divisionId"><option selected="selected" value="<?php echo $em->divisionId;?>"><?php echo $em->division;?></select></td></tr>
					<tr><td>Department:&nbsp;&nbsp;</td><td><div id="deptdiv"><select name="deptId"></select></div></td></tr>
					<tr><td>Unit:&nbsp;&nbsp;</td><td><div id="unitdiv"><select name="unitId"></select></div></td></tr>
					
					
					<tr><td>Employee No:&nbsp;&nbsp;</td><td><input type="Text" name="employeeNo" size="15" readonly="readonly" value="<?php echo $em->employeeNo;?>"></td></tr>
					<tr><td>Date Hired:&nbsp;&nbsp;</td><td><input type="Text" name="dateHired" id="dateHired" readonly="readonly" value="<?php echo $em->dateHired;?>" size="15"></td></tr>
					<tr><td>Bank Account No:&nbsp;&nbsp;</td><td><input type="Text" name="bankAccountNo" readonly="readonly" value="<?php echo $em->bankAccountNo;?>" size="15"></td></tr>
					<tr><td>Locker No:&nbsp;&nbsp;</td><td><input type="Text" name="lockerNo" readonly="readonly" value="<?php echo $em->lockerNo;?>" size="15"></td></tr>
					<tr><td>Employment Status:&nbsp;&nbsp;</td><td><select name="employmentStatus" id="employmentStatus"><option selected="selected" value="<?php echo $em->employmentStatus;?>"><?php echo $em->employmentStatus;?></select></td></tr>
					<tr><td>Residency Training Program:&nbsp;&nbsp;</td><td><select name="residencyTrainingProgram"><option selected="selected" value="<?php echo $em->residencyTrainingProgram;?>"><?php echo $em->residencyTrainingProgram;?></select></td></tr>
					<tr><td>Pay Type:&nbsp;&nbsp;</td><td><select name="payType"><option selected="selected" value="<?php echo $em->payType;?>"><?php echo $em->payType;?></select></td></tr>
					<tr><td>Level:&nbsp;&nbsp;</td><td><select name="level"><option value="<?php echo $em->level;?>" selected="selected"><?php echo "Level ".$em->level;?></select></td></tr>
					<tr><td>Taxable:&nbsp;&nbsp;</td><td><input type="Radio" readonly="readonly" name="isTaxable" value="1" <?php if($em->isTaxable==1){echo "checked='checked'";}?>>Yes<input type="Radio" name="isTaxable" value="0" <?php if($em->isTaxable==0){echo "checked='checked'";}?>>No</td></tr>					
					<tr><td>Biometric No:&nbsp;&nbsp;</td><td><input type="Text" name="biometricNo" readonly="readonly" size="15" value="<?php echo $em->biometricNo;?>"></td></tr>
				 </table>   
			</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
	 	...
	 	<tr>
			<td>
				<table>
					...
					<tr><td>Sex:&nbsp;&nbsp;</td><td><input type="Text" name="sex" size="15" value="<?php echo $em->sex;?>"></td></tr>
					<tr><td>Blood Type:&nbsp;&nbsp;</td><td><input type="Text" name="bloodType" size="4" value="<?php echo $em->bloodType;?>"></td></tr>
					...
					<tr><td>Birth Date:&nbsp;&nbsp;</td><td><input type="Text" name="birthDate" id="birthDate" size="15" value="<?php echo $em->birthDate;?>"><a href="javascript:show_calendar('employeefrm2.birthDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
					...
					<tr><td>SSS No:&nbsp;&nbsp;</td><td><input type="Text" name="sssNumber" size="15" value="<?php echo $em->sssNumber;?>"></td></tr>
					<tr><td>PHIC No:&nbsp;&nbsp;</td><td><input type="Text" name="phicNumber" size="15" value="<?php echo $em->phicNumber;?>"></td></tr>
					<tr><td>Pag-ibig No:&nbsp;&nbsp;</td><td><input type="Text" name="pagibigNumber" size="15" value="<?php echo $em->pagibigNumber;?>"></td></tr>
					<tr><td>TIN:&nbsp;&nbsp;</td><td><input type="Text" name="tin" size="15" value="<?php echo $em->tin;?>"></td></tr>
				 </table>   
			</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td colspan="2">Dependent <input type="Hidden" name="personalcounter" id="personalcounter" value="0"></td></tr>
		<tr>
			<td>
				<table>
					<?php
					...
					<tr>
						...
						<table>					
							<tr>
								...
								<td><input type="Text" name="birthDate<?php echo $a;?>" id="birthDate<?php echo $a;?>" size="15" value="Birth Date" style="color:gray;" onfocus="if(this.value=='Birth Date'){this.value='';}this.style.color='black';"><a href="javascript:show_calendar('employeefrm2.birthDate<?php echo $a;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td>
					...
					<tr>
						...
						<table>					
							<tr>
								...
								<td><input type="Text" name="fromDateedu<?php echo $b;?>" id="fromDateedu<?php echo $b;?>" size="15" value="From" style="color:gray;" onfocus="if(this.value=='From'){this.value='';}this.style.color='black';"><a href="javascript:show_calendar('employeefrm2.fromDateedu<?php echo $b;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td>
								<td><input type="Text" name="toDateedu<?php echo $b;?>" id="toDateedu<?php echo $b;?>" size="15" value="To" style="color:gray;" onfocus="if(this.value=='To'){this.value='';}this.style.color='black';"><a href="javascript:show_calendar('employeefrm2.toDateedu<?php echo $b;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td>								
							</tr>
						</table>
						</div>
						</td>
					...
					<tr>
						...
						<table>
							...
							<tr>							
								...
								<td><input type="Text" name="fromDateemp<?php echo $c;?>" id="fromDateemp<?php echo $c;?>" size="6"><a href="javascript:show_calendar('employeefrm2.fromDateemp<?php echo $c;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a>
									 to 
									 <input type="Text" name="endDateemp<?php echo $c;?>" id="endDateemp<?php echo $c;?>" size="6"><a href="javascript:show_calendar('employeefrm2.endDateemp<?php echo $c;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td>
							</tr>
							<tr>
								<td>Company Address:</td>
								<td>Supervisor:</td>
					...
					<tr>
						...
						<table>
							<tr>
								...
								<td><td>Date/s :&nbsp;&nbsp;<input type="Text" name="fromDateprof<?php echo $d;?>" id="fromDateprof<?php echo $d;?>" size="6"><a href="javascript:show_calendar('employeefrm2.fromDateprof<?php echo $d;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a>
								 to 
								 <input type="Text" name="endDateprof<?php echo $d;?>" id="endDateprof<?php echo $d;?>" size="6">
								 <a href="javascript:show_calendar('employeefrm2.endDateprof<?php echo $d;?>');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a>
								 </td></td>
							</tr>
