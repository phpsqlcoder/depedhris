	 	...
	 	<tr>
			<td>
				<table>
					...
					<tr><td>Department:&nbsp;&nbsp;</td><td><div id="deptdiv"></div>
							<div id="deptIdDatediv" style="font-size:10p;display:none;"><strong style="color:blue;">Effectivity Date:</strong><input style="visibility:hidden;" type="Text" name="deptIdDate" id="deptIdDate" size="15" value="<?php echo date('Y-m-d');?>"><a href="javascript:show_calendar('employeefrm.deptIdDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></div>
							</td></tr>
					...
					<tr><td>Union Member:&nbsp;&nbsp;</td><td><?php if($em->isUnionMember==1){echo "Yes";}?>Yes <?php if($em->isUnionMember==0){echo "No";}?></td></tr>					
					<tr><td>Coop Member:&nbsp;&nbsp;</td><td><input readonly="readonly" type="Radio" style="visibility:hidden;" name="isCoopMember" value="1" <?php if($em->isCoopMember==1){echo "checked='checked'";}?>>Yes<input style="visibility:hidden;" type="Radio" name="isCoopMember" value="2" <?php if($em->isCoopMember==0){echo "checked='checked'";}?>>No</td></tr>					
