...
include("../dbcon.php");
?>
     <h2>Total Duty per Dept</h2>
     <form action="reports/output/duty_dept_total.php" method="post" target="foo" id="frmrpts" name="frmrpts" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
