...
?>    
     ...
     <form name="frmrptdd" id="frmrptdd" action="reports/output/time_summary.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	 <tr>
