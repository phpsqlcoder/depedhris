...
include("../dbcon.php");
?>
     <h2>Corrective Gap Memo</h2>
     <form action="reports/output/correctivegapmemo.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
   <table width="100%">
	  <tr><td>
