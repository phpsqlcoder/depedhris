...
?>
     ...
     <h2>Monthly Infraction Report</h2>
     <form name="frmrpts" id="frmrpts" action="reports/output/cod_monthly.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	 	<tr>
	  ...
	  <tr>
	  <td><input type="checkbox" name="dep" checked> Group by Division/Department<br><input type="checkbox" name="sex" value="eksel"> Result to Excel</td>
