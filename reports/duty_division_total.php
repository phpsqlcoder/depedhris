...
include("../dbcon.php");
?>
     <h2>Total Duty per Division</h2>
     <form action="reports/output/duty_division_total.php" method="post" target="foo" id="frmrpts" name="frmrpts" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
