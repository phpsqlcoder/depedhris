...
?>
     ...
     <h2>Absent Report</h2>
     <form name="frmrpts" id="frmrpts" action="reports/output/absent_monthly.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">		
	 	<tr>
