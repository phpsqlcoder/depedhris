...
include("../dbcon.php");
?>    
     <h2>Overtime Report (Detailed)</h2>
     <form name="frmrptdd" id="frmrptdd" action="reports/output/overtimedetailed.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="60%">
	 <tr>
