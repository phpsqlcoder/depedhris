...
?>
     <h2>Leave Ledger</h2>
     <form name="frmrpt" action="reports/output/leavelimit.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
		  ...
		  <td>Year: <select name="yer"><?php echo $optionyear;?></td>
