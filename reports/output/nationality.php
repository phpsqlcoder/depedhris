...
//elseif($_POST['sex']=='on'){$cond.="'FEMALE'";}
     //$cond=rtrim($cond,",");
$qry.=" WHERE e.nationality = '".$_POST['nationality']."' and e.isActive=1";
$qry.=" ORDER BY e.nationality,e.lastName,e.firstName";
...
if($_POST['eksel']=='on'){
	...
	?>
     ...
     <table width="80%" style="font-family:Arial;font-size:12px;">
	  <tr>
	       <td colspan="6" align="center" style="font-size:14px;font-weight:bold;">Employee List by Nationality<br> <?php echo $_POST['nationality'];?></td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
	  <tr>
	       <td>Seq</td>
