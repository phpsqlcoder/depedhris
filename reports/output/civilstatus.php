...
//elseif($_POST['sex']=='on'){$cond.="'FEMALE'";}
     //$cond=rtrim($cond,",");
$qry.=" WHERE e.civilStatus = '".$_POST['civilstatus']."' and e.isActive=1";
$qry.=" ORDER BY e.civilStatus,e.lastName,e.firstName";
...
?>
     <?php
if($_POST['eksel']=='on'){
		$filename ="reportbycivilstatus.xls";
	...
	?>
     ...
     <table width="80%" style="font-family:Arial;font-size:12px;">
	  <tr>
	       <td colspan="6" align="center" style="font-size:14px;font-weight:bold;">Employee List by Civil Status<br> <?php echo $_POST['civilstatus'];?></td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
	  <tr>
	       <td>Seq</td>
