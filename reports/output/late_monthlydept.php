...
$qry="SELECT e.ndex as emp,e.biometricNo as bio,e.firstName,e.lastName,e.middleName,p.name as position,d.name as dept from employee e left join position p on p.ndex=e.position left join dept d on d.ndex=e.deptId
...
$qry.=" and d.ndex in (".$_SESSION['deptId'].")";
