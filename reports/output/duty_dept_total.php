...
$qry="SELECT di.name as division,
d.name as dept, sum(t.days_work) as tots
...
$qry.=" group by di.name,d.name having sum(t.days_work)>0";
//echo $qry;
...
?>
	...
	?>
	 ...
	 <tr><td>&nbsp;</td></tr>
	  <tr>
	       <td colspan="7" align="center" style="font-size:14px;font-weight:bold;">Total Duty per Dept</td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
