...
//elseif($_POST['sex']=='on'){$cond.="'FEMALE'";}
     //$cond=rtrim($cond,",");
$qry.=" WHERE e.bloodType = '".$_POST['bloodtype']."' and e.isActive=1";
$qry.=" ORDER BY e.bloodType,e.lastName,e.firstName";
...
?>
     <?php
if($_POST['eksel']=='on'){
		$filename ="reportbybloodtype.xls";
	...
	?>
     ...
     <table width="80%" style="font-family:Arial;font-size:12px;">
	  <tr>
	       <td colspan="6" align="center" style="font-size:14px;font-weight:bold;">Employee List by Bloodtype<br> Type <?php echo $_POST['bloodtype'];?></td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
	  <tr>
	       <td>Seq</td>
