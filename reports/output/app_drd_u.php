...
$qry.=" WHERE (k.date >= '".$cutoffDate['cutoffDateStart']."' and k.date <= '".$cutoffDate['cutoffDateEnd']."') and k.tayp='drd' ".$cond."";
...
if($_POST['eksel']=='on'){
	...
	?>
     ...
     <table width="100%" style="font-family:Arial;font-size:12px;">
	  <tr>
	       <td colspan="12" align="center" style="font-size:14px;font-weight:bold;">Duty Restday Application (Unapproved)<br> 
