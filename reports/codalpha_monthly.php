...
?>
     ...
     <h2>Monthly Infraction Report (Alpha List)</h2>
     <form name="frmrpts" id="frmrpts" action="reports/output/codalpha_monthly.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	 	<tr>
