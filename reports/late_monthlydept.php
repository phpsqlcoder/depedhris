...
?>
     ...
     <h2>Late Report</h2>
     <form name="frmrpts" id="frmrpts" action="reports/output/late_monthlydept.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">		
	 	<tr>
			...
			<td style="visibility:hidden;">Dept:&nbsp;&nbsp;<select name="dept"><option value='ALL'>ALL<?php echo $optiondept;?></select></td>			
		</tr>
		<tr>
			...
			<td style="visibility:hidden;">Employee:<input type="Text" name="emptxt"><font color="red" style="font-style:italic;">Enter First or Last name..</font></td>
		</tr>
