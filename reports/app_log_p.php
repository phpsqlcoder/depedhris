...
?>
     <h2>Forgot to Log -  Online Application Checker</h2>
     <form name="frmrptdd" action="reports/output/app_log_p.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
