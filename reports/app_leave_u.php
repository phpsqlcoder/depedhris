...
?>
     <h2>Leave -  Unapproved Application</h2>
     <form name="frmrptdd" action="reports/output/app_leave_u.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
