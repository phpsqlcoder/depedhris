...
function changeurl(a,b){
    window.location.href='employeelogs2023.php?id='+a+'&mants='+b;
}
</script>
</head>
<body>
...
<form name="frmcompo" action="employeelogs2023.php?act=adnew&id=<?php echo $_GET['id'];?>" method="post">
...
<form name="wee" id="wee" action="employeelogs2023.php?act=ot&mants=<?php echo $defco;?>&id=<?php echo $_GET['id'];?>&lastdate=<?php echo $lastdate;?>&lasthrisid=<?php echo $lasthrisid;?>" method="post">
<table style="font-family:Arial;font-size:12px;" width="100%">
    <tr>
