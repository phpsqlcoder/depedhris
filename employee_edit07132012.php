...
<form method="post" name="employeefrm" action="<?php echo $_SERVER['PHP_SELF']; ?>?act=save&id=<?php echo $id;?>" enctype="multipart/form-data" onsubmit="return checks();">
	 	...
	 	<tr>
			<td>
				<table>
					...
					<tr><td>Position:&nbsp;&nbsp;</td><td><select name="position"><?php echo $optionposition;?><option selected="selected" value="<?php echo $em->position;?>"><?php echo $em->newposition;?></select></td></tr>					
					...
					<tr><td>Department:&nbsp;&nbsp;</td><td><div id="deptdiv"><select name="deptId"><option value="">- Select Division -<?php echo $optdept;?></select></div></td></tr>
					...
					<tr><td>Bank Account No:&nbsp;&nbsp;</td><td><input type="Text" name="bankAccountNo" value="<?php echo $em->bankAccountNo;?>" size="15"></td></tr>
					<tr><td>Locker No:&nbsp;&nbsp;</td><td><input type="Text" name="lockerNo" value="<?php echo $em->lockerNo;?>" size="15"></td></tr>
					<tr><td>Employment Status:&nbsp;&nbsp;</td><td><select name="employmentStatus" id="employmentStatus" <?php echo $employeeNoLock; ?>><?php echo $optionemploymentstatus;?><option selected="selected" value="<?php echo $em->employmentStatus;?>"><?php echo $em->employmentStatus;?></select></td></tr>
					...
					<tr><td>Taxable:&nbsp;&nbsp;</td><td><input type="Radio" name="isTaxable" value="1" <?php if($em->isTaxable==1){echo "checked='checked'";}?>>Yes<input type="Radio" name="isTaxable" value="0" <?php if($em->isTaxable==0){echo "checked='checked'";}?>>No</td></tr>					
