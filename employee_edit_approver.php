...
ob_start();
session_start();
if(!$_SESSION['isApprovingOfficer']){echo "".$_SESSION['firstName']." ".$_SESSION['lastName']." You are not allowed to access this page!<br> Your name has been recorded.<br><a href='kiosk/menu.php'>Back to kiosk</a>";die();}
if($_SESSION['isApprovingOfficer']==0){echo "".$_SESSION['firstName']." ".$_SESSION['lastName']." You are not allowed to access this page!<br> Your name has been recorded.<br><a href='kiosk/menu.php'>Back to kiosk</a>";die();}
...
<form method="post" name="employeefrm" action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $id;?>" enctype="multipart/form-data" onsubmit="alert('You dont have access right to update this record!'); return false;">
	 	...
	 	<tr>
			<td>
				<table>
					...
					<tr><td>Bank Account No:&nbsp;&nbsp;</td><td><input type="Text" name="bankAccountNo" <?php if($_SESSION['ndex']!='15' && $_SESSION['ndex']!='22' ){echo "readonly='readonly'";}?> value="<?php echo $em->bankAccountNo;?>" size="15"></td></tr>
				 	...
				 	<tr>
						<td>
							<table>
								...
								<tr><td>Occupational Permit #:&nbsp;&nbsp;</td><td><input type="Text" name="occupationalPermitNo" size="15" value="<?php echo $em->occupationalPermitNo;?>"> Date Issued:<input value="<?php echo $em->occupationalPermitDate;?>" type="Text" name="occupationalPermitDate" id="occupationalPermitDate" size="15"><a href="javascript:show_calendar('employeefrm.occupationalPermitDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
								<tr><td>PTR #:&nbsp;&nbsp;</td><td><input type="Text" name="ptrNo" size="15" value="<?php echo $em->ptrNo;?>"> Date Issued:<input type="Text" name="ptrNoDate" id="ptrNoDate" size="15" value="<?php echo $em->ptrNoDate;?>"><a href="javascript:show_calendar('employeefrm.ptrNoDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
								<tr><td>Cedula #:&nbsp;&nbsp;</td><td><input type="Text" name="cedulaNo" size="15" value="<?php echo $em->cedulaNo;?>"> Date Issued:<input type="Text" name="cedulaDate" id="cedulaDate" size="15" value="<?php echo $em->cedulaDate;?>"><a href="javascript:show_calendar('employeefrm.cedulaDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
								<tr><td>City Health #:&nbsp;&nbsp;</td><td><input type="Text" name="cityHealth" size="15" value="<?php echo $em->cityHealth;?>"> Date Issued:<input type="Text" name="cityHealthDate" id="cityHealthDate" size="15" value="<?php echo $em->cityHealthDate;?>"><a href="javascript:show_calendar('employeefrm.cityHealthDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
								<tr><td>PRC #:&nbsp;&nbsp;</td><td><input type="Text" name="prcNo" size="15" value="<?php echo $em->prcNo;?>"> Date Issued:<input type="Text" name="prcDate" id="prcDate" size="15" value="<?php echo $em->prcDate;?>"><a href="javascript:show_calendar('employeefrm.prcDate');" onMouseOver="window.status='Date Picker'; overlib(''); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="b_calendar.png" width=19 border=0></a></td></tr>
							 </table>   
						</td>
					</tr>
               	</table>
              ...
              <div class="col-md-12">
                <table width="100%">
					...
					<tr>
						<td>
							<table>
								<iframe src="emp_upload_files_approver.php?id=<?php echo $_GET['id'];?>" height="300" width="100%"></iframe>	
							</table>			
						</td>
					</tr>
              	</table>
