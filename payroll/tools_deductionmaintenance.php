...
$sql = "SELECT * FROM dedsetup   
											WHERE 1";
if ($_GET['pageact'] == 'add'){
	$result = mysql_query("INSERT INTO dedsetup ( `dedType` , `amount` , `encodedBy`)
					VALUES ('".$_POST['dedType']."', '".$_POST['amount']."', '".$_SESSION['ndex']."')",$conn);
...
<div id="main_content_wrap" class="container_12">
   <h2>Tools >> Deduction Maintenance &nbsp;&nbsp;&nbsp;&nbsp; </h2> 
	 <div class="clearfix">
	 	<table cellpadding="0" cellspacing="0" border="0" width="1020">
			<td  width="415" valign="top">
				...
				<table cellpadding="3" cellspacing="0" border="0">
					...
					<tr><td width="170">Deduction Name</td><td><input type="text" name="dedType" value="<?php echo $rs1['dedType']?>"></td></tr>
					<tr><td>Amount </td><td><input type="text" name="amount" value="<?php echo $rs1['amount'];?>"></td></tr>
					<tr><td>Status</td><td><select name="loanType"><?php echo $optionSelectstatus_selected.$optionSelectstatus;?></select></td></tr>
					...
					<tr>
						<td colspan="2" align="left">
							...
							<table cellpadding="5" cellspacing="0" border="0" width="100%">
								<tr class="columnheader"><td>Deduction Name</td><td align="right">Amount</td><td align="right">Action</td></tr>
