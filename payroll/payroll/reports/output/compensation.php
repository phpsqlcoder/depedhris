	  ...
	  $ctr1s++;
		...
		if($r->departmentName != $prevDepartment){
			if($ln != 1){
				...
				$data .= "<tr><td colspan='4'></td><td colspan='6'><hr></td></tr>";
				$data .= " <tr>
		...
		$grandTotalBasicPayP += $MPay;
		$grandTotalBasicPayD += $DMPay;
...
if($_POST['eksel']=='on'){
	...
	?>
	 ...
	 <thead>
	  <tr>
	       <td colspan="11" align="center" style="font-size:11px;font-weight:bold;">Compensation Master File<br> <?php echo $reportTitle;?></td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
