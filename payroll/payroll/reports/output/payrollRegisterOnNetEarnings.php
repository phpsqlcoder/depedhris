...
while($r=mysql_fetch_assoc($exec)){
	...
	$janA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
	...
	$janB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					 FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-01-01')))."' && empid='".$r['empid']."' {$level}"));
	$febA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					 FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-02-15')))."' && empid='".$r['empid']."' {$level}"));
	$febB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					 FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-02-01')))."' && empid='".$r['empid']."' {$level}"));
	$marA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-03-15')))."' && empid='".$r['empid']."' {$level}"));
	$marB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-03-01')))."' && empid='".$r['empid']."' {$level}"));
	$aprA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-04-15')))."' && empid='".$r['empid']."' {$level}"));
	$aprB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-04-01')))."' && empid='".$r['empid']."' {$level}"));
	$mayA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-05-15')))."' && empid='".$r['empid']."' {$level}"));
	$mayB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-05-01')))."' && empid='".$r['empid']."' {$level}"));
	$junA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-06-15')))."' && empid='".$r['empid']."' {$level}"));
	$junB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-06-01')))."' && empid='".$r['empid']."' {$level}"));
	$julA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-07-15')))."' && empid='".$r['empid']."' {$level}"));
	$julB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-07-01')))."' && empid='".$r['empid']."' {$level}"));
	$augA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-08-15')))."' && empid='".$r['empid']."' {$level}"));
	$augB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-08-01')))."' && empid='".$r['empid']."' {$level}"));
	$sepA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-09-15')))."' && empid='".$r['empid']."' {$level}"));
	$sepB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-09-01')))."' && empid='".$r['empid']."' {$level}"));
	$octA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-10-15')))."' && empid='".$r['empid']."' {$level}"));
	$octB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-10-01')))."' && empid='".$r['empid']."' {$level}"));
	$novA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-11-15')))."' && empid='".$r['empid']."' {$level}"));
	$novB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-t',strtotime(date($_POST['PayrollYear'].'-11-01')))."' && empid='".$r['empid']."' {$level}"));
	$decA = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
																					  FROM payroll WHERE pay_period='".date('Y-m-d',strtotime(date($_POST['PayrollYear'].'-12-15')))."' && empid='".$r['empid']."' {$level}"));
	$decB = mysql_fetch_assoc(mysql_query("SELECT SUM(netBasic + cola + allowance + honorarium + payNightPremium + payOTReg + payOTExc + oth_income + onCallOvertime + payDutyRd + paySpHoliday + payLHoliday + otRDLHolidayPay + otRDSHolidayPay + otLHolidayPay + otSHolidayPay + otRestDayPay - payUndertime +  adj_other) grossPay, 
																 SUM(d_pnb + d_parkingFee + d_whtax + d_sss + d_philhealth + pagibig + pagibigloan + pagibigloanh + d_unionDues + d_mortuary + d_sssloan + d_hospital + d_cashAdvance + d_other + d_coopTotal + financialAssistance + pagibigSavings) totalDeduction
