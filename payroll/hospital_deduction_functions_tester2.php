...
//var_dump(get_billings(2137,"2023-10-15"));
//echo compute_payment('15155', '200003697', '2426', '2022-03-31');
$bills = get_amortization('18745', '220003157', '2137');
$payables = get_payables('18745', '220003157', '2137');
$paid = get_paid('18745', '220003157', '2137');
echo $bills." xx ".$paid." xx ".$payables;
// receiver 18745	220003157
