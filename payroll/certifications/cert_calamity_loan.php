...
$pagibigno="Pag-IBIG NO. ".$emp->sssNumber;
$pq=mysql_query("select * from payroll where pay_period>='".getpayperiod($_POST['st'])."' and pay_period<='".getpayperiod($_POST['en'])."' and empid='".$_POST['id']."' and days_work>0");

while($p=mysql_fetch_object($pq)){
	$ded=mysql_fetch_object(mysql_query("select e.* from loan_employee_payments e left join loansetup s on s.ndex=e.loanSetupId where e.datePaid='".$p->pay_period."' and s.employeeId='".$_POST['id']."' and s.loanType='CALAMITYLOAN'"));
...
<table style="font-family:Arial;font-size:16px;" width="100%">
	...
	<tr><td colspan="6" align="center"><u><strong style="font-size:20px;">CERTIFICATION OF PREMIUM PAYMENTS</strong></u><br><br></td></tr>
	<tr><td colspan="6"><?php echo $_POST['h1']?><br><br></td></tr>
	<tr><td colspan="6"><p><?php echo str_replace("<pagibig no>",$pagibigno,str_replace("<employee>",$employeename,$_POST['h2']));?></p><br></td></tr>
	...
	<tr><td colspan="3">&nbsp;</td><td colspan="4">DAVAO DOCTORS HOSPITAL<br>PEN No. <?php echo $_POST['h5']?><br><br><br></td></tr>
...
<form name="frmcompo" action="cert_calamity_loan.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Header Text:</td><td><textarea name="h1" rows="3" cols="60">To Whom It May Concern:</textarea></td></tr>
	<tr><td>Top Paragraph:</td><td><textarea name="h2" rows="3" cols="60">Herewith are the loan payments of <employee> with <pagibig no> follows:</textarea></td></tr>
	<tr><td>Bottom Paragraph:</td><td><textarea name="h3" rows="3" cols="60">This certification is issued upon request of the above-named for Calamity Loan Payments purposes only:</textarea></td></tr>
	...
	<tr><td>DDH PEN:</td><td><textarea name="h5" rows="3" cols="60">23-022400020-1</textarea></td></tr>
	<tr><td>SIGNATORY:</td><td><textarea name="h6" rows="3" cols="60">MARIA DOLORES B. BENIGNO</textarea></td></tr>
	<tr><td>POSITION:</td><td><textarea name="h7" rows="3" cols="60">COMPENSATION & BENEFIT HEAD</textarea></td></tr>
