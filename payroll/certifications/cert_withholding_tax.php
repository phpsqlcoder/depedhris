...
$sssno="Tax Identification Number (TIN) ".$emp->tin;
$pq=mysql_query("select * from payroll where pay_period>='".getpayperiod($_POST['st'])."' and pay_period<='".getpayperiod($_POST['en'])."' and empid='".$_POST['id']."' and days_work>0 and d_whtax>0");
...
while($p=mysql_fetch_object($pq)){		
	...
	$data.="<tr style='background-color:".$bgclr1s.";'>
				<td>".$p->pay_period."</td>
				<td>".number_format($p->d_whtax,2)."</td>				
				<td>".$or[$or_field]."</td>
...
<table style="font-family:Arial;font-size:16px;" width="100%">
	...
	<tr><td colspan="6" align="center"><u><strong style="font-size:20px;">CERTIFICATE OF PAYMENTS</strong></u><br><br></td></tr>
	...
	<tr><td colspan="3">&nbsp;</td><td colspan="4">DAVAO DOCTORS HOSPITAL<br>TIN <?php echo $_POST['h5']?><br><br><br></td></tr>
...
<form name="frmcompo" action="cert_withholding_tax.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Header Text:</td><td><textarea name="h1" rows="3" cols="50">TO: BUREAU OF INTERNAL REVENUE</textarea></td></tr>
	<tr><td>Top Paragraph:</td><td><textarea name="h2" rows="3" cols="60">Herewith are the Income Tax payments of <employee> with <sss no> follows:</textarea></td></tr>
	<tr><td>Bottom Paragraph:</td><td><textarea name="h3" rows="3" cols="60">This certification is issued upon the request of the above-named for Income Tax Payments purposes only.</textarea></td></tr>
	...
	<tr><td>DDH TIN:</td><td><textarea name="h5" rows="3" cols="60">005-985-874-000</textarea></td></tr>
	<tr><td>SIGNATORY:</td><td><textarea name="h6" rows="3" cols="60">MIRASOL B. TIU</textarea></td></tr>
