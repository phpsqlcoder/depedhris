...
$pageTitle='SSS Salary Loan Payments';
?>
...
$pq=mysql_query("select * from payroll where pay_period>='".getpayperiod($_POST['st'])."' and pay_period<='".getpayperiod($_POST['en'])."' and empid='".$_POST['id']."' and days_work>0 and d_sssloan>0");
...
while($p=mysql_fetch_object($pq)){
	...
	$data.="<tr style='background-color:".$bgclr1s.";'>
				<td>".$p->pay_period."</td>
				<td>".number_format($p->d_sssloan,2)."</td>				
				<td>".$or[$or_field]."</td>
...
<form name="frmcompo" action="cert_sss_salary_loan.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Top Paragraph:</td><td><textarea name="h2" rows="3" cols="60">Herewith are the loan payments of <employee> with <sss no> follows:</textarea></td></tr>
	<tr><td>Bottom Paragraph:</td><td><textarea name="h3" rows="3" cols="60">This certification is issued upon the request of the above-named for Loan Payments purposes only.</textarea></td></tr>
