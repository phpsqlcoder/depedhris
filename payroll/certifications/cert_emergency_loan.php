...
<form name="frmcompo" action="cert_emergency_loan.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Bottom Paragraph:</td><td><textarea name="h3" rows="3" cols="60">This certification is issued upon request of the above-named for Emergency Loan Payments purposes only:</textarea></td></tr>
