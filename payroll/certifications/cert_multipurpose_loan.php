...
$sssno="Pagibig NO. ".$emp->phicNumber;
...
while($p=mysql_fetch_object($pq)){
	...
	$data.="<tr style='background-color:".$bgclr1s.";'>
				<td>".$p->pay_period."</td>
				<td>".number_format($p->pagibigloan,2)."</td>				
				<td>".$or[$or_field]."</td>
...
<form name="frmcompo" action="cert_multipurpose_loan.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Bottom Paragraph:</td><td><textarea name="h3" rows="3" cols="60">This certification is issued upon request of the above-named for Multi-Purpose Loan Payments  purposes only:</textarea></td></tr>
