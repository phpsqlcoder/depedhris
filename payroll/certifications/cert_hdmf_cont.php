...
$pageTitle='HDMF Employee Contribution';
?>
...
$pagibigNumber="Pag-IBIG No. ".$emp->pagibigNumber;
...
while($p=mysql_fetch_object($pq)){
	...
	$data.="<tr style='background-color:".$bgclr1s.";'>
				<td>".$p->pay_period."</td>
				<td>".number_format($p->pagibig  + $p->pagibigSavings,2)."</td>
				<td>".number_format($pg,2)."</td>
				<td>".$or[$or_field]."</td>
...
<table style="font-family:Arial;font-size:16px;" width="100%">
	...
	<tr><td colspan="6"><p><?php echo str_replace("<hdmf no>",$pagibigNumber,str_replace("<employee>",$employeename,$_POST['h2']));?></p><br></td></tr>
	...
	<tr><td colspan="3">&nbsp;</td><td colspan="4">By:<br><?php echo $_POST['h6']?><br>BENEFITS HEAD<br></td></tr>
</table>
<?php
}
	else 
...
<form name="frmcompo" action="cert_hdmf_cont.php?act=go" method="post">
<table style="font-family:Arial;font-size:12px;">
	...
	<tr><td>Top Paragraph:</td><td><textarea name="h2" rows="3" cols="60">Herewith are the premium payments of <employee> with <hdmf no> follows:</textarea></td></tr>
