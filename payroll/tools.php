...
if(isset($_GET['update_his'])){
	$tot_emp = mysql_fetch_array(mysql_query("select * from employee order by ndex DESC limit 1"));
	mysql_select_db("hr_interface_db",$conn);
	$tot_hisemp = mysql_fetch_array(mysql_query("select * from employee order by ndex DESC limit 1"));
	mysql_select_db("hris",$conn);
	
	//echo $tot_emp['ndex']."  xx  ".$tot_hisemp['ndex'];

	if($tot_emp['ndex'] > $tot_hisemp['ndex']){
		for($xx=($tot_hisemp['ndex']+1); $xx<=$tot_emp['ndex']; $xx++){
		//echo "INSERT INTO hr_interface_db.employee SELECT * from hris.employee where ndex='".$xx."'<br>";
		$insert = mysql_query("INSERT INTO hr_interface_db.employee SELECT * from hris.employee where ndex='".$xx."'");
		}
	}
}
?>
...
<tr style="height:30px;font-size:14px;"><td align="center"><u>Hospital Deductions</u></td></tr>
    		<tr style="height:30px"><td><a href="tools_sync.php" style="text-decoration:none;"><img src="../images/usercontract.png" height="15" width="15">&nbsp;Download Hospital Deductions</a></td></tr>
    		<tr style="height:30px"><td><a href="tools_sync.php" style="text-decoration:none;"><img src="../images/usercontract.png" height="15" width="15">&nbsp;Upload Hospital Payments to HIS</a></td></tr>
...
<tr style="height:30px"><td><a href="tools.php?update_his=go" style="text-decoration:none;"><img src="../images/usercontract.png" height="15" width="15">&nbsp;Update HIS Employee Records</a></td></tr>
