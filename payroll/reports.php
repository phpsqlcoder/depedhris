  ...
  <tr>
    ...
    <td>
      <table style="color:maroon;font-weight:bold;font-size:12px;">
				...
				<tr style="height:30px"><td><a href="#" onclick="report('eecompensationHistory');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Employee Compensation History</a></td></tr>
                ...
                <tr style="height:30px"><td><a href="#" onclick="report('monthly_sss_salaryloan');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Monthly SSS Salary Loan</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('monthly_hdmfhousing');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Monthly HDMF Housing Loan</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('monthly_hdmfmultipurpose');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Monthly HDMF Multi Purpose Loan</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('monthly_sssemergency');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Monthly SSS Emergency Loan</a></td></tr>
      </table>
    </td>
	<td>
      <table style="color:maroon;font-weight:bold;font-size:12px;">
			  <tr style="height:30px;font-size:14px;"><td align="center"><u>Government Reports</u></td></tr>
				...
				<tr style="height:30px"><td><a href="#" onclick="report('sssSummaryreport_hoadmin');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;SSS Summary with HO Admin </a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('phicSummaryreport_hoadmin');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;PHIC Summary with HO Admin </a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('hdmfSummaryreport_hoadmin');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;HDMF Summary with HO Admin </a></td></tr>
    ...
    <td>
      <table style="color:maroon;font-weight:bold;font-size:12px;">
			  <tr style="height:30px;font-size:14px;"><td align="center"><u>Payroll Reports</u></td></tr>
				...
				<tr style="height:30px"><td><a href="#" onclick="report('payrollRegistersummarydept');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Payroll Reports Per Department</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('payrollEntryReport');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Payroll Entry Report</a></td></tr>
				...
				<tr style="height:30px"><td><a href="#" onclick="report('generateJournalEntryDept');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Generate Journal Entry</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('journalEntryReport');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Journal Entry Report</a></td></tr>
				...
				<tr style="height:30px"><td><a href="#" onclick="report('govtloan');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Government Remittances and Loan</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('payrollTimeSummary_inday');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Payroll Time Summary(Date Range)</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('payrollTimeSummary_inday');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Overtime Report(Date Range)</a></td></tr>
				<tr style="height:30px"><td><a href="#" onclick="report('over30percent');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Less 30% Netpay</a></td></tr>
	...
	<td>
      <table style="color:maroon;font-weight:bold;font-size:12px;">
			  <tr style="height:30px;font-size:14px;"><td align="center"><u>Deduction Reports</u></td></tr>
				...
				<tr style="height:30px"><td><a href="#" onclick="report('hisDeductionReport');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Hospital Deduction Report </a></td></tr>
		
				<tr style="height:30px"><td><a href="#" onclick="report('hisBillReport');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Hospital Bill Balance Report </a></td></tr>

				<tr style="height:30px"><td><a href="#" onclick="report('hisBillReport_asof');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Hospital Bill Balance Report (As of) </a></td></tr>

				<tr style="height:30px"><td><a href="#" onclick="report('ytdhospital');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;YTD Hospital Deduction Report </a></td></tr>
<tr style="height:30px"><td><a href="#" onclick="report('loan_employee');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Employee Loan Deduction Report </a></td></tr>
      </table>
    </td>
   ...
   <tr>
    ...
    <td>
      <table style="color:maroon;font-weight:bold;font-size:12px;">
				...
				<tr style="height:30px"><td><a href="#" onclick="report('employeeYTDPayrollRegister13th');" style="text-decoration:none;"><img src="../images/report1.png" height="15" width="15">&nbsp;Employee YTD 13th Payroll Register</a></td></tr>
