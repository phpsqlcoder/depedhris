...
?>
     ...
     <form name="frmrpt" action="reports/output/hisBillReport_asof.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
		  <td>
				...
				<td>
					...
					<td colspan="2"> Asof: <input type="date" name="asof">&nbsp;
