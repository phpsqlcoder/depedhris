...
?>
     ...
     <form name="frmrpt" action="reports/output/journalEntryReport.php" method="post" target="foo1" onsubmit="window.open('', 'foo1', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
		  <td>Payroll Period <select name="PayrollDate"><?php echo $optionSelectPayrollCutoffDate;?></select> &nbsp;
