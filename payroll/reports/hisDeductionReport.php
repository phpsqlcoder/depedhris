...
?>
     ...
     <table width="80%">
	  ...
	  <tr>
	  	...
	  	<td colspan="2"><input type="checkbox" name="payroll">Include Payroll &nbsp; <input type="checkbox" name="manual">Include Manual &nbsp; <input type="checkbox" name="eksel" value="on"> Result to Excel</td>
