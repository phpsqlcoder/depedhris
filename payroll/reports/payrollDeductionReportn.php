...
$rs = mysql_query("SELECT * FROM cutoffdates ORDER BY payrollDate DESC limit 24",$conn);
...
?>
     ...
     <form name="frmrpt" action="reports/output/payrollDeductionReportn.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
