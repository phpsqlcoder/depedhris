...
?>
     ...
     <form name="frmrpt" action="reports/output/payrollRegistersalaryonhold.php" method="post" target="foo" onsubmit="window.open('', 'foo', 'width=1000,height=600,status=yes,resizable=yes,scrollbars=yes');">
     <table width="80%">
	  <tr>
