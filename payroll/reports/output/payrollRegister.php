...
while($r=mysql_fetch_assoc($exec)){
		...
		//echo $r['netBasic']." + ".$r['cola']." + ".$r['allowance']." + ". $r['honorarium'] ." + ". $r['payNightPremium'] ." + ". $r['payOTReg'] ." + ". $r['payOTExc'] ." + ". $r['oth_income'] ." + ". $r['onCallOvertime'] ." + ". $r['payDutyRd']." + ". $r['paySpHoliday'] ." + ". $r['payLHoliday'] ." + ". $r['payOTExc'] ." + ". $r['otRDLHolidayPay'] ." + ". $r['otRDSHolidayPay'] ." + ". $r['otLHolidayPay']." + ". $r['otSHolidayPay'] ." + ". $r['otRestDayPay']." - ". $r['payUndertime'] ." + ". $r['adj_other'];		
		//echo "<br>".$grossPay;
		//echo $r['payOTExc']." + ".$r['payOTReg']." + ".$r['paySpHoliday']." + ".$r['payLHoliday'] ." + ". $r['payDutyRd'] ." + ".$r['otRDLHolidayPay'] ." + ". $r['otRDSHolidayPay']." + ". $r['otLHolidayPay'] ." + ". $r['otSHolidayPay'] ." + ". $r['otRestDayPay'];
		//die();
	  ...
	  $ctr1s++;
		...
		if($r['departmentName'] != $prevDepartment){
			if($ln != 1){
				$data .= "<tr><td colspan='2'>No. of Personnel: $countPerDepartment</td><td colspan='23'><hr></td></tr>";
				$countPerDepartment = 0;
				$data .= " <tr>
			...
			$data .= " <tr><td colspan='25' align='left' style='font-size:11px;'>".$r['departmentName']."</td></tr>";
		}		
		$countPerDepartment++;
    ...
    $data.="<tr bgcolor='".$bgclr1s."' align='right'>
					      ...
					      <td>".number_format($r['cola'] - $colaUndertimeAmount,2)."</td>
								...
								<td>".number_format(($r['oth_income'] + $r['onCallOvertime'] + $r['adj_other'] + $r['adj_13th_mon_pay']),2)."&nbsp; </td>
		...
		$subTotalAdjustment += $r['oth_income']  + $r['onCallOvertime']  + $r['adj_other'] + $r['adj_13th_mon_pay'];
		...
		if ($ln == $rowCount){
			//$data .= "<tr><td colspan='2'></td><td colspan='22'><hr></td></tr>";
				$data .= "<tr><td colspan='2'>No. of Personnel: $countPerDepartment</td><td colspan='25'><hr></td></tr>";
				$countPerDepartment = 0;
				$data .= " <tr>
											<td colspan='2'> Sub Total</td>
											<td align='right'>".number_format($subTotalBasicPay,2)."&nbsp; </td>
				...
				$data .= "<tr><td colspan='26'>&nbsp;Total no of personnel: $ln</td></tr>";
				$data .= " <tr>
...
if($_POST['eksel']=='on'){
	...
	?>
	 ...
	 <thead>
	  <tr>
	       <td colspan="25" align="center" style="font-size:13px;">DAVAO DOCTORS HOSPITAL<br>PAYROLL REGISTER<br /><?php echo $reportTitle;?><br>
