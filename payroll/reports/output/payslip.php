				...
				<tr valign="TOP">
					<td colspan="2">
							<table cellpadding="1" cellspacing="0" style="font-family:tahoma, Arial;font-stretch:condensed;font-size:12px;" border="0" width="100%"0>
								...
								<tr><td>Cola</td><td>=</td><td align="right"><?php echo number_format($r['cola'],2);?></td><td><?php echo $dayReflect;?></td><td>PHIC</td><td>=</td><td align="right"><?php echo number_format($r['d_philhealth'],2);?></td><td>PAG PREM</td><td>=</td><td align="right"><?php echo number_format($r['pagibig'] + $r['pagibigSavings'],2);?></td></tr>	
