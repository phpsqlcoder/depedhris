...
/*******
* Resigned Employee Before The End Of The Year 
* Employee Without Payroll On December And Up Of The Year And Is Resigned
*******/
...
$sql = "SELECT e.ndex empid, e.lastName, e.firstName, e.middleName, e.employeeNo, e.tin, d.name, ec.basicPay, e.civilStatus, ec.payTypeNdex
								...
								LEFT JOIN payroll p ON p.empid=e.ndex
										WHERE e.isActive = '0'
											  AND e.endDate BETWEEN '".$_POST['year']."-01-01' AND '".$_POST['year']."-12-01'
											  AND p.pay_period BETWEEN '".$_POST['year']."-01-01' AND '".$_POST['year']."-12-01'
	 ...
	 <thead>
	  <tr>
	    <td align="LEFT" style="font-size:13px;" colspan="10">
		   BIR FORM 1604CF - SCHEDULE 7.1<br>
