...
while($r=mysql_fetch_assoc($exec)){
    ...
    $data.="<tr bgcolor='".$bgclr1s."' align='right'>
	 							<td align='left'>".getID($r['employmentStatus'],$r['employeeNo'])."&nbsp; </td>
					      		...
					      		<td>".number_format($r['financialAssistance'],2)."&nbsp; </td>
				     </tr>";
	$coopTotal += $r['financialAssistance'];

}
?>
     <?php
if($_POST['eksel']=='on'){
		$filename ="fadeductionreport.xls";
	...
	?>
	 ...
	 <thead>
	  <tr>
	       <td colspan="24" align="center" style="font-size:13px;">DAVAO DOCTORS HOSPITAL<br>FINANCIAL ASSISTANCE DEDUCTION<br /><?php echo $reportTitle;?><br>
