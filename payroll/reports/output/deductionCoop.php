...
while($r=mysql_fetch_assoc($exec)){
	...
	$coopTotal += $r['d_coopTotal'];

}
?>
     <?php
if($_POST['eksel']=='on'){
		$filename ="coopdeductionreport.xls";
	...
	?>
	 ...
	 <thead>
	  <tr>
	       <td colspan="24" align="center" style="font-size:13px;">DAVAO DOCTORS HOSPITAL<br>COOP DEDUCTION<br /><?php echo $reportTitle;?><br>
	  ...
	  <tr><td colspan="3"><hr></td></tr>
	   <tr valign="bottom" align="center">
			<td colspan="2">TOTAL</td>
	     	<td align="right"><?php echo $coopTotal;?></td>
	  </tr>
	  </tbody>
      </table>
