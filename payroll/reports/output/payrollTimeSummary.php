...
$sql = "SELECT e.lastName, e.firstName, e.middleName, p.undertime, p.ot_reg, p.ot_exc, p.days_work, p.duty_rd, p.vac_lve, p.man_lve, p.sick_lve, p.days_absent, p.night_prem FROM employee e LEFT JOIN payroll p ON p.empid = e.ndex WHERE e.isActive='1' && p.pay_period='".$PayrollCutoff."'";
