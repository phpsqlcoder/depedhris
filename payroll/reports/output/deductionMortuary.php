...
while($r=mysql_fetch_assoc($exec)){
	...
	$coopTotal += $r['d_mortuary'];

}
?>
     <?php
if($_POST['eksel']=='on'){
		$filename ="mortuarydeductionreport.xls";
	...
	?>
	 ...
	 <thead>
	  <tr>
	       <td colspan="24" align="center" style="font-size:13px;">DAVAO DOCTORS HOSPITAL<br>MORTUARY DEDUCTION<br /><?php echo $reportTitle;?><br>
