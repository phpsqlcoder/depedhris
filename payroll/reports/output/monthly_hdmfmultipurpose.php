...
if($_POST['eksel']=='on'){
	...
	?>
     ...
     <table width="100%" style="font-family:Arial;font-size:12px;">
	  <tr>
	       <td colspan="20" align="center" style="font-size:14px;font-weight:bold;">Monthly HDMF Multi Purpose Loan<br> <?php echo $fd." to ".$ld."<br>".$hdr;?></td>
	  </tr>
	  <tr><td>&nbsp;</td></tr>
	  <tr>
	       <td>Seq</td>
	       <td>Name</td>
		   <td>/hdmf multipurpose</td>
