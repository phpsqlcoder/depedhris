...
function cutline($filename,$line_no=-1) {   	// BEGIN funtion for delete file.txt per line
	...
	$sql = "select SUM(p.d_whtax) taxTotalPerDept, d.name departmentName,
	...
	while($r=mysql_fetch_assoc($rs)){
		...
		$data .="<tr align='left'>
					...
					<td align='right'>".number_format($r['taxTotalPerDept'] ,2)."</td>
				</tr>";
				
		$totalTaxWithHeld += $r['taxTotalPerDept'];
	}
if($_POST['eksel']=='on'){
		$filename ="birSummaryreport.xls";
