...
if (empty($_GET['myact']) && empty($_GET['pageact'])){
	...
	//die();
	$postLoan = mysql_query("UPDATE loansetup SET posted='1' where ndex = ".$_GET['id']."",$conn);
	 	...
	 	<table cellpadding="0" cellspacing="0" border="0" width="1020">
			<td  width="415" valign="top">
				...
				<table cellpadding="3" cellspacing="0" border="0">
					...
					<tr><td>Loan Amount</td><td><input type="text" name="loanAmount" value="<?php echo $rs1['loanAmount']?>"></td></tr>
					...
					<tr>
						<td colspan="2" align="left">
							...
							<table cellpadding="5" cellspacing="0" border="0" width="100%">
								<tr class="columnheader"><td>Name</td><td align="right">LoanAmount</td><td align="right">No. of ded</td><td  align="right">Start of Ded<br />(Date)</td><td align="right">Action</td></tr>
